//Calculadora de Division de dos valores.
...
Console.WriteLine("Escribe número o el valor a Dividir: "); //Mostrar a Usuario instruccion a realizar
...
Console.WriteLine("Escribe número o el valor por el cual Dividir: ");
...
Console.WriteLine("El Resultado Total de la DIVISION es de: " + Total); // Mostramos a Usuario el texto de resultado e incluimos en Valor Total a lo mostrado en consola
Console.ReadKey();