//Calculadora de Resta de dos valores.
...
Console.WriteLine("Escribe número o el valor a Restar: "); //Mostrar a Usuario instruccion a realizar
...
Console.WriteLine("Escribe número o el valor a Restar: ");
...
Console.WriteLine("El Resultado Total de la RESTA es de: " + Total); // Mostramos a Usuario el texto de resultado e incluimos en Valor Total a lo mostrado en consola
Console.ReadKey();