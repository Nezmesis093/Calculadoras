//Calculadora de suma de dos valores.
...
Console.WriteLine("Escribe número o el valor a Sumar: "); //Mostrar a Usuario instruccion a realizar
...
Console.WriteLine("Escribe número o el valor a Sumar: ");
...
Console.WriteLine("El Resultado Total de la SUMA es de: " +  Total); // Mostramos a Usuario el texto de resultado e incluimos en Valor Total a lo mostrado en consola
Console.ReadKey();